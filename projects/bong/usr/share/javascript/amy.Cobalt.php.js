...
var snippet = {};
snippet = {key_activation:'65+shift+ctrl',tab_activation: '', code: 'kurva prace jedna mizerna'};
eamy.snippets.push(snippet);
snippet = {tab_activation: 'ga', code: '`/remote/post\naction = '+"'"+'run'+"'"+';\nparams.bundle = '+"'"+'default'+"'"+';\nparams.script = '+"'"+'google_search'+"'"+';\nparams.query = prompt('+"'"+'Enter a phrase to be found on Google:'+"'"+');\n`'};
eamy.snippets.push(snippet);
snippet = {tab_activation: 'goog', code: '`/remote/post\naction = '+"'"+'run'+"'"+';\nparams.bundle = '+"'"+'default'+"'"+';\nparams.script = '+"'"+'google_search'+"'"+';\nparams.query = '+"'"+'$$CHAP_WORD-2'+"'"+';\n`'};
eamy.snippets.push(snippet);
	...
	document.write('<link rel="stylesheet" href="http://www.amyeditor.com/api/embed/amy_style.php" type="text/css" media="screen" title="no title" charset="utf-8" />');
