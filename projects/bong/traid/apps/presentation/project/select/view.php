...
<div class="bong-admin-central">
	...
	<div class="bong-admin-central-right">
		<h6 class="bong-admin-component-headline">Controler XDO</h6>
		...
		<h6 class="bong-admin-component-headline">Spirit XDO</h6>
		<a class="bong-admin-component-xdo" href="#">0524100d1e7fcda48c2ae728f78d7faf</a>
		<a class="bong-admin-component-xdo" href="#">4524100d1e7fcda48c2ae728f78d7faf</a>
		<a class="bong-admin-component-xdo" href="#">bb6def095c09284ed8d9ec2e7bca6b3a</a>
		<a class="bong-admin-component-xdo" href="#">d9ee234525bc1c8bff4c6b2a6876aeea</a>
	...
	<div class="bong-admin-central-main">
		<?php $controller->spirit('ProjectProperties')->main(); ?>
	</div>
</div>
<!--
<div class="bong-admin-editor">
	<div class="bong-admin-editor-title">
		Bong Code Editor
	</div>
	<div class="bong-admin-editor-body">
		<div class="bong-admin-editor-filename">
			<label>File: </label><span>/var/www/bong/projects/bong/usr/local/common/layout/layout.php</span>
		</div>
		<textarea id="bong-admin-editor-code"></textarea>
	</div>
	<div class="bong-admin-editor-bottom">
		<div class="bong-admin-editor-bottom-info">
			Content Loaded
		</div>
		<button class="bong-dialog-btn bong-dialog-btn-default">Save</button>
		<button class="bong-dialog-btn">Discard</button>
	</div>
</div>
-->
